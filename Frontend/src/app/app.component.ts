...
export class AppComponent implements OnInit {
  ...
  gotoVideos()
  {
    this.router.navigate(['/khub'], { queryParams: { source: 'video' } })
  }
  gotoArticle()
  {
    this.router.navigate(['/khub'] , { queryParams: { source: 'article' } })
  }
  gotoQueries()
  {
    this.router.navigate(['/khub'] , { queryParams: { source: 'query' } })
  }
  goToMarket()
  {
